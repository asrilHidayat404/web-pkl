const HomeLayout = ({pengaju}) => {
    return (
        <div className="container px-6 py-8 mx-auto">
            <div className="mt-4">
            <div className="flex flex-wrap -mx-6 justify-evenly">
              <div className="w-full px-6 sm:w-1/2 xl:w-1/3 flex-1">
              ...
              <div className="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0 flex-1">
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Total Pengaju</div>
                  </div>
                </div>
              </div>
